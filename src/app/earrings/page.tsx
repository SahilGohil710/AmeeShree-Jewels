    ...
    <div className="container mx-auto max-w-7xl py-16 px-4 md:px-6">
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {filteredEarrings.slice(0, visibleCount).map((earring) => (
            <Card key={earring.id} className="overflow-hidden shadow-md hover:shadow-lg group-hover:scale-105 transition-all duration-300 border border-border/60 rounded-lg group flex flex-col">
