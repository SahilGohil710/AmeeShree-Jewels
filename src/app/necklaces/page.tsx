...
const NecklaceCard = ({ necklace, index }: { necklace: typeof placeholderNecklaces[0], index: number }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-gray-300 mt-1 min-h-[3em]">{necklace.description}</p>
      </div>
    </div>
  );
};
