       ...
       <div className="relative w-full min-h-[80vh] flex items-center justify-center text-center overflow-hidden">
         ...
         <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-8 text-center">
           ...
           <p className="text-lg md:text-xl font-light tracking-wider text-white/80 mt-4 animate-text-focus-in animation-delay-200">
            ...
            <div className="mt-8 animate-text-focus-in animation-delay-800 flex flex-wrap justify-center gap-4">
             <Link href="/bridal-collection" passHref>
              ...
              <Button
                variant="outline"
                size="lg"
                className="scale-90 animate-scale-in animation-delay-1000 transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-lg hover:shadow-primary/20 rounded-xl bg-white/10 text-white backdrop-blur-sm border-white/50 hover:bg-white hover:text-primary"
              >
                Book an Appointment
              </Button>
            </Link>
