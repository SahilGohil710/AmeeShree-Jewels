    ...
    <div className="container mx-auto max-w-5xl py-16 md:py-24 px-4 md:px-6">
      <div className="space-y-12 md:space-y-16">
        ...
        <div className="space-y-8 text-center">
            <h2 className="text-2xl md:text-3xl font-semibold text-primary">Our Commitment to Trust</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="flex flex-col items-center p-6 bg-card rounded-lg border border-border/40 shadow-sm">
                    <ShieldCheck className="h-10 w-10 text-primary mb-3"/>
                    <h3 className="text-xl font-semibold text-primary">BIS Hallmark Certified</h3>
                    <p className="text-foreground/80 text-sm mt-2">All our gold jewelry is BIS Hallmarked, ensuring purity, authenticity, and government-certified quality you can trust.</p>
                </div>
                <div className="flex flex-col items-center p-6 bg-card rounded-lg border border-border/40 shadow-sm">
                    <Award className="h-10 w-10 text-primary mb-3"/>
                    <h3 className="text-xl font-semibold text-primary">Internationally Certified Diamonds</h3>
                    <p className="text-foreground/80 text-sm mt-2">Our diamonds are certified by reputed international labs like IGI and GIA, guaranteeing authenticity, quality, and ethical sourcing.</p>
                </div>
            </div>
        </div>
