    ...
    <div className="container mx-auto max-w-7xl py-16 px-4 md:px-6">
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {filteredBridalSets.slice(0, visibleCount).map((set) => (
            <Card key={set.id} className="overflow-hidden shadow-lg hover:shadow-primary/20 transition-shadow duration-300 border border-border/60 rounded-lg group flex flex-col">
              <CardContent className="p-0">
                <div
                  className="aspect-square relative overflow-hidden rounded-t-lg cursor-pointer group/image"
              ...
              <CardHeader className="p-4 flex-grow">
                ...
                <CardDescription className="text-sm text-foreground/70 pt-1 min-h-[3em]">
                  {set.description}
                </CardDescription>
              </CardHeader>
            </Card>
