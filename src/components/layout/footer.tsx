...
import { Gem, Instagram, MessageSquare, ShieldCheck, Award } from 'lucide-react'; 
    ...
    <footer className="bg-background border-t border-border/40 mt-auto shadow-inner">
      <div className="container mx-auto max-w-screen-xl px-4 md:px-6 py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 text-sm">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="flex space-x-4 pt-2">
                 <a href="https://www.instagram.com/_ameeshree.jewels_?igsh=MTE4Z3BxM29zOTRycw==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-foreground/70 hover:text-primary transition-colors duration-150">
                  <Instagram className="h-5 w-5" />
                 </a>
                  <a href="https://wa.me/919819264909" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-foreground/70 hover:text-primary transition-colors duration-150">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/custom-jewelry" className="text-foreground/80 hover:text-primary transition-colors duration-150">Custom Jewelry</Link></li>
               <li><Link href="/book-appointment" className="text-foreground/80 hover:text-primary transition-colors duration-150">Book Appointment</Link></li>
            </ul>
          </div>
          ...
          {/* Our Commitment */}
          <div className="space-y-3">
             <h4 className="text-base font-semibold text-primary mb-3 uppercase tracking-wider">Our Commitment</h4>
              <div className="space-y-3 text-foreground/70">
                 <div className="flex items-start gap-2">
                    <ShieldCheck className="h-5 w-5 mt-0.5 shrink-0 text-primary/80"/>
                    <p>All gold jewelry is BIS Hallmarked, ensuring government-certified purity and quality.</p>
                 </div>
                 <div className="flex items-start gap-2">
                    <Award className="h-5 w-5 mt-0.5 shrink-0 text-primary/80"/>
                    <p>All diamonds are certified by reputed international labs like IGI and GIA, guaranteeing authenticity.</p>
                 </div>
              </div>
          </div>
        </div>
        ...
        <div className="text-center text-xs text-foreground/60 space-y-2">
           <p>BIS Hallmarked Gold | IGI/GIA Certified Diamonds | Ethical Sourcing | Lifetime Support</p>
          <p>© 2020-{currentYear} AmeeShree Jewels - By{' '}
          <a
