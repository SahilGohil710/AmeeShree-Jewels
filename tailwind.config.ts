...
export default {
  ...
  theme: {
    container: { // Add container settings if not present
      center: true,
      padding: "2rem",
      screens: {
        "2xl": "1400px",
  	...
  	extend: {
      fontFamily: {
        sans: ["var(--font-eb-garamond)", ...fontFamily.sans], // Use EB Garamond variable
      },
  		colors: {
        // Updated color definitions using HSL variables
        ...
        'light-sheen': 'light-sheen 3s ease-in-out infinite',
        ...
        'hero-zoom': 'hero-zoom 15s ease-out forwards',
  		}
  	}
  },
  plugins: [
