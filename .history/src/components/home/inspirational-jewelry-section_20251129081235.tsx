...
const inspirationalContent: InspirationalItem[] = [
  {
    id: 'insp1',
    imageSrc: 'public/Images/Scroll_Animation/The_Birth_of_Imagination.png',
  ...
  {
    id: 'insp2',
    imageSrc: 'public/Images/Scroll_Animation/The_Soul_of_the_Stone.png',
  ...
  {
    id: 'insp3',
    imageSrc: 'public/Images/Scroll_Animation/The_Final_Radiance.png',
